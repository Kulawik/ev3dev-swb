...
docker run --rm -it -v $app:/home/compiler/app_ ev3cc /bin/bash -c "cd app_ && mkdir -p $build && cd $build && cmake ..  -DCMAKE_TOOLCHAIN_FILE=/home/compiler/toolchain-armel.cmake && make"
